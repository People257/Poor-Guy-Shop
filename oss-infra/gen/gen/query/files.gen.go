...
func newFile(db *gorm.DB, opts ...gen.DOOption) file {
	...
	_file.FileKey = field.NewString(tableName, "file_key")
	...
	_file.Category = field.NewString(tableName, "category")
	_file.OwnerID = field.NewString(tableName, "owner_id")
	_file.Visibility = field.NewString(tableName, "visibility")
	_file.Status = field.NewInt16(tableName, "status")
...
type file struct {
	...
	ALL        field.Asterisk
	ID         field.String // 文件ID, 主键
	Filename   field.String // 原始文件名
	FileKey    field.String // 文件存储键
	FilePath   field.String // 文件存储路径
	FileSize   field.Int64  // 文件大小(字节)
	MimeType   field.String // 文件MIME类型
	FileHash   field.String // 文件SHA256哈希值
	Category   field.String // 文件分类: avatar, product, document
	OwnerID    field.String // 文件所有者ID
	Visibility field.String // 可见性: public, private
	Status     field.Int16  // 文件状态: 1=正常, 2=已删除
...
func (f *file) updateTableName(table string) *file {
	...
	f.Status = field.NewInt16(table, "status")
