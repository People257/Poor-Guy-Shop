...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.PermissionName = field.NewString(tableName, "permission_name")
...
func (p *permission) updateTableName(table string) *permission {
	...
	p.PermissionName = field.NewString(table, "permission_name")
...
func (p *permission) fillFieldMap() {
	...
	p.fieldMap["id"] = p.ID
	p.fieldMap["permission_name"] = p.PermissionName
