...
func newUserAddress(db *gorm.DB, opts ...gen.DOOption) userAddress {
	...
	_userAddress.ReceiverName = field.NewString(tableName, "receiver_name")
	_userAddress.ReceiverPhone = field.NewString(tableName, "receiver_phone")
	...
	_userAddress.Longitude = field.NewField(tableName, "longitude")
	_userAddress.Latitude = field.NewField(tableName, "latitude")
...
type userAddress struct {
	...
	ALL           field.Asterisk
	ID            field.String // 地址ID，主键，使用UUID
	UserID        field.String // 用户ID，外键关联users表
	ReceiverName  field.String // 收货人姓名，最长100字符
	ReceiverPhone field.String // 收货人电话，支持手机号和固话
	Province      field.String // 省份
	City          field.String // 城市
	District      field.String // 区/县
	Street        field.String // 街道详细地址，最长200字符
	PostalCode    field.String // 邮政编码，可选
	AddressLabel  field.String // 地址标签，如：家、公司、学校等
	IsDefault     field.Bool   // 是否为默认地址，每个用户只能有一个默认地址
	Longitude     field.Field  // 经度，用于地图定位，可选
	Latitude      field.Field  // 纬度，用于地图定位，可选
...
func (u *userAddress) updateTableName(table string) *userAddress {
	...
	u.Longitude = field.NewField(table, "longitude")
	u.Latitude = field.NewField(table, "latitude")
