...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.TotalAmount = field.NewField(tableName, "total_amount")
	_order.DiscountAmount = field.NewField(tableName, "discount_amount")
	_order.ShippingFee = field.NewField(tableName, "shipping_fee")
	_order.ActualAmount = field.NewField(tableName, "actual_amount")
	_order.PaymentMethod = field.NewString(tableName, "payment_method")
	_order.PaymentStatus = field.NewInt32(tableName, "payment_status")
	_order.PaymentTime = field.NewTime(tableName, "payment_time")
	_order.DeliveryTime = field.NewTime(tableName, "delivery_time")
	_order.ReceiveTime = field.NewTime(tableName, "receive_time")
	...
	_order.Version = field.NewInt32(tableName, "version")
...
type order struct {
	...
	ALL            field.Asterisk
	ID             field.String
	OrderNo        field.String // 订单号，格式：ORD+年月日+序号
	UserID         field.String
	Status         field.Int32 // 订单状态：1待付款 2已付款 3已发货 4已收货 5已取消 6已退款
	TotalAmount    field.Field
	DiscountAmount field.Field
	ShippingFee    field.Field
	ActualAmount   field.Field
	PaymentMethod  field.String
	PaymentStatus  field.Int32 // 支付状态：0未支付 1已支付 2退款中 3已退款
	PaymentTime    field.Time
	DeliveryTime   field.Time
	ReceiveTime    field.Time
	CancelTime     field.Time
...
func (o *order) updateTableName(table string) *order {
	...
	o.TotalAmount = field.NewField(table, "total_amount")
	o.DiscountAmount = field.NewField(table, "discount_amount")
	o.ShippingFee = field.NewField(table, "shipping_fee")
	o.ActualAmount = field.NewField(table, "actual_amount")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["actual_amount"] = o.ActualAmount
