...
func newOrderPayment(db *gorm.DB, opts ...gen.DOOption) orderPayment {
	...
	_orderPayment.ID = field.NewString(tableName, "id")
	_orderPayment.OrderID = field.NewString(tableName, "order_id")
	_orderPayment.PaymentNo = field.NewString(tableName, "payment_no")
	_orderPayment.PaymentMethod = field.NewString(tableName, "payment_method")
	_orderPayment.PaymentAmount = field.NewField(tableName, "payment_amount")
	_orderPayment.PaymentStatus = field.NewInt32(tableName, "payment_status")
	_orderPayment.ThirdPartyNo = field.NewString(tableName, "third_party_no")
	_orderPayment.PaymentTime = field.NewTime(tableName, "payment_time")
	_orderPayment.RefundTime = field.NewTime(tableName, "refund_time")
	_orderPayment.Remark = field.NewString(tableName, "remark")
	...
	_orderPayment.Version = field.NewInt32(tableName, "version")
...
type orderPayment struct {
	...
	PaymentAmount field.Field
	PaymentStatus field.Int32
	ThirdPartyNo  field.String
...
func (o *orderPayment) updateTableName(table string) *orderPayment {
	...
	o.PaymentNo = field.NewString(table, "payment_no")
	o.PaymentMethod = field.NewString(table, "payment_method")
	o.PaymentAmount = field.NewField(table, "payment_amount")
	o.PaymentStatus = field.NewInt32(table, "payment_status")
	o.ThirdPartyNo = field.NewString(table, "third_party_no")
...
func (o *orderPayment) fillFieldMap() {
	...
	o.fieldMap["payment_no"] = o.PaymentNo
	...
	o.fieldMap["third_party_no"] = o.ThirdPartyNo
