...
func newOrderItem(db *gorm.DB, opts ...gen.DOOption) orderItem {
	...
	_orderItem.SkuID = field.NewString(tableName, "sku_id")
	_orderItem.ProductName = field.NewString(tableName, "product_name")
	_orderItem.ProductImage = field.NewString(tableName, "product_image")
	_orderItem.SkuName = field.NewString(tableName, "sku_name")
	_orderItem.Price = field.NewField(tableName, "price")
	_orderItem.Quantity = field.NewInt32(tableName, "quantity")
	_orderItem.TotalAmount = field.NewField(tableName, "total_amount")
	...
	_orderItem.Version = field.NewInt32(tableName, "version")
...
type orderItem struct {
	...
	SkuID        field.String
	ProductName  field.String // 商品名称，冗余存储防止商品被删除
...
func (o *orderItem) updateTableName(table string) *orderItem {
	...
	o.SkuID = field.NewString(table, "sku_id")
	o.ProductName = field.NewString(table, "product_name")
	o.ProductImage = field.NewString(table, "product_image")
	o.SkuName = field.NewString(table, "sku_name")
	o.Price = field.NewField(table, "price")
...
func (o *orderItem) fillFieldMap() {
	...
	o.fieldMap["product_image"] = o.ProductImage
