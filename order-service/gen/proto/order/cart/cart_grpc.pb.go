...
const (
	CartService_AddCartItem_FullMethodName     = "/order.cart.CartService/AddCartItem"
	CartService_UpdateCartItem_FullMethodName  = "/order.cart.CartService/UpdateCartItem"
	CartService_RemoveCartItem_FullMethodName  = "/order.cart.CartService/RemoveCartItem"
	CartService_GetCart_FullMethodName         = "/order.cart.CartService/GetCart"
	CartService_ClearCart_FullMethodName       = "/order.cart.CartService/ClearCart"
	CartService_SelectCartItems_FullMethodName = "/order.cart.CartService/SelectCartItems"
)
...
type CartServiceClient interface {
	...
	// 选择/取消选择购物车商品
	SelectCartItems(ctx context.Context, in *SelectCartItemsReq, opts ...grpc.CallOption) (*SelectCartItemsResp, error)
}
...
func (c *cartServiceClient) AddCartItem(ctx context.Context, in *AddCartItemReq, opts ...grpc.CallOption) (*AddCartItemResp, error) {
...
func (c *cartServiceClient) UpdateCartItem(ctx context.Context, in *UpdateCartItemReq, opts ...grpc.CallOption) (*UpdateCartItemResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *cartServiceClient) SelectCartItems(ctx context.Context, in *SelectCartItemsReq, opts ...grpc.CallOption) (*SelectCartItemsResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SelectCartItemsResp)
	err := c.cc.Invoke(ctx, CartService_SelectCartItems_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	...
	// 选择/取消选择购物车商品
	SelectCartItems(context.Context, *SelectCartItemsReq) (*SelectCartItemsResp, error)
}
...
func (UnimplementedCartServiceServer) AddCartItem(context.Context, *AddCartItemReq) (*AddCartItemResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddCartItem not implemented")
}
func (UnimplementedCartServiceServer) UpdateCartItem(context.Context, *UpdateCartItemReq) (*UpdateCartItemResp, error) {
...
func (UnimplementedCartServiceServer) SelectCartItems(context.Context, *SelectCartItemsReq) (*SelectCartItemsResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SelectCartItems not implemented")
}
...
func _CartService_AddCartItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).AddCartItem(ctx, req.(*AddCartItemReq))
	}
...
func _CartService_SelectCartItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SelectCartItemsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).SelectCartItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_SelectCartItems_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).SelectCartItems(ctx, req.(*SelectCartItemsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "order.cart.CartService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CartService_SelectCartItems_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "order/cart/cart.proto",
}
